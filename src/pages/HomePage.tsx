      ...
      >
            ...
            <div className="w-full lg:w-1/2 max-w-2xl">
              ...
              <div className="flex gap-6 ">
                ...
                <div className="flex flex-col items-center gap-3 text-center w-20">
                  <div className="w-14 h-14 rounded-full border border-[#E8D399] flex items-center justify-center text-yellow-400">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                  </div>
                  <span className="text-xs font-semibold text-black leading-tight">People First</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-3 text-center w-20">
                  ...
                  <span className="text-xs font-semibold text-black leading-tight">Transparent<br />Governance</span>
                </div>

                {/* Feature 3 */}
                <div className="flex flex-col items-center gap-3 text-center w-20">
                  <div className="w-14 h-14 rounded-full border border-[#E8D399] flex items-center justify-center text-yellow-400">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
                  </div>
                  <span className="text-xs font-semibold text-black leading-tight">Development<br />for All</span>
                </div>

                {/* Feature 4 */}
                <div className="flex flex-col items-center gap-3 text-center w-20">
                  <div className="w-14 h-14 rounded-full border border-[#E8D399] flex items-center justify-center text-yellow-400">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path></svg>
                  </div>
                  <span className="text-xs font-semibold text-black leading-tight">Better<br />Tomorrow</span>
                </div>
              </div>
            ...
            <div className="w-full lg:w-auto max-w-[480px]">
              <div className="bg-white  rounded-3xl p-6 shadow-2xl">
                ...
                <div className="flex justify-between items-start gap-4 mb-6">
                  ...
                  <div className="flex flex-col items-center text-center w-1/3">
                    <img src="/lokesh.jpg" alt="Sri Nara Lokesh" className="w-20 h-20 rounded-full object-cover mb-2 border-2 border-gray-100" />
        ...
        <div className="relative z-20 w-full max-w-[1500px] mx-auto px-6 lg:px-12 xl:px-20 mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
            ...
            <div className="col-span-1 relative bg-[#FDF9EE] rounded-[32px] border border-[#F2DEAA]/60 p-6 lg:p-8 overflow-hidden shadow-sm flex flex-col justify-between min-h-[280px]">
              <div className="relative z-10 w-2/3 md:w-3/5">
                <h3 className="text-xl font-extrabold text-gray-900 mb-2 leading-tight">Explore Your Village Development</h3>
                <p className="text-sm text-gray-700 mb-8 font-medium">Select your village on the map to see development works and progress</p>
                <button className="bg-[#1A1A1A] hover:bg-black text-white px-5 py-2.5 rounded-xl text-sm font-bold flex items-center gap-2 transition w-max mt-auto shadow-md">
              ...
              {/* Map Graphic (Using absolute placeholder image for styling) */}
              <div className="absolute right-0 top-0 bottom-0 w-3/5 pointer-events-none opacity-80 z-0">
                <img src="/map-bg.png" alt="" className="w-full h-full object-cover object-right" />
              </div>
            </div>

            {/* Card 2: Transformation Stories */}
            <div className="col-span-1 relative bg-[#FDF9EE] rounded-[32px] border border-[#F2DEAA]/60 p-6 lg:p-8 overflow-hidden shadow-sm flex flex-col justify-between min-h-[280px]">
              <div className="relative z-10 w-1/2 md:w-1/2 pr-4">
                <h3 className="text-xl font-extrabold text-gray-900 mb-2 leading-tight">Transformation Stories</h3>
                <p className="text-sm text-gray-700 mb-8 font-medium">Real changes. Real impact. Explore before & after development works.</p>
              ...
              <div className="absolute right-0 top-0 bottom-0 w-1/2 z-0">
                <img src="/before-after.jpg" alt="Transformation Before and After" className="w-full h-full object-cover" />
                {/* Slider UI Element */}
                <div className="absolute inset-y-0 left-1/2 w-0.5 bg-white shadow-lg flex items-center justify-center -ml-[1px]">
                  <div className="w-7 h-7 bg-white rounded-full shadow flex items-center justify-center text-gray-500">
            ...
            <div className="col-span-1 relative bg-[#F1BA06] rounded-[32px] p-6 lg:p-8 overflow-hidden shadow-sm flex flex-col justify-between min-h-[280px]">
              <div className="relative z-10 w-2/3 md:w-3/5">
                <h3 className="text-xl font-extrabold text-gray-900 mb-1 leading-tight">Voice of Our People</h3>
                <p className="text-sm text-gray-800 mb-5 font-medium">Your opinion shapes our future projects.</p>
              ...
              {/* People Graphic */}
              <div className="absolute right-0 bottom-0 w-[55%] h-full pointer-events-none z-0">
                <img src="/voice-people.png" alt="Citizens providing feedback" className="w-full h-full object-cover object-bottom" />
              </div>
            </div>
