...
// ─────────────────────────────────────────────────────────────────────────────
export default function RealMap({ isTelugu, activeYear = 2026, selectedVillage, onSelectVillage, issues }: RealMapProps) {
    ...
    const [tileMode, setTileMode] = useState<string>('satellite');
